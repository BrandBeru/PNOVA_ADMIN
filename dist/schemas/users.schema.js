...
exports.updateUserSchema = exports.findUserByName = exports.deleteUserSchema = exports.getUserSchema = exports.createUserSchema = void 0;
...
const profilePicture = joi_1.default.string().min(5).max(200);
